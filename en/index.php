...
<body>
		...
		<div class="banner">
			<section id="slippry-slider" class="full-width">
				<article class="demo_block">
					...
					<ul id="demo1">
						<?php
						$demo1 = CheckHaveRowDB::slectFrom("home_banner_en")['data'];
						foreach ($demo1 as $k => $v) {
						?>
							<li><img src="../back-office/images/home/banner/en/<?= $v['pc'] ?>"></li>
						<?php
						}
						?>
		...
		<div class="banner-m">
			<section id="slippry-slider" class="full-width">
				<article class="demo_block">
					...
					<ul id="demo2">
						<?php
						$demo2 = CheckHaveRowDB::slectFrom("home_banner_en")['data'];
						foreach ($demo2 as $k => $v) {
						?>
							<li><img src="../back-office/images/home/banner/en/<?= $v['mobile'] ?>"></li>
						<?php
						}
						?>
					</ul>
	...
	<div class="content">
		<div class="left-01">
			<div class="box-main">
				<div class="title-top">The Saraburi Chamber of Commerce</div>
				...
				<div class="more-01"><a href="aboutus.php">Read More></a></div>
			</div>
		...
		<div class="left-02">
			<div class="box-main">
				...
				<div class="title-all">News &amp; Activities</div>
		...
		<div class="left-03">
			<div class="box-main">
				...
				<div class="title-all">Member Benefits</div>
				...
				<div class="box-text-benefits-home">
					...
					<?php
					$home_benefit_th = CheckHaveRowDB::slectFrom("home_benefit_en")['data'];
				...
				<div class="more-all-01"><a href="benefits.php">View All</a></div>
				<div class="btn-line-register"><a href="register-ordinary.php"><img src="../images/icon-register.jpg" width="65" height="65" />Register</a></div>
			</div>
		</div>

		<div class="left-02">
			<div class="box-main">
				<div class="title-all">Saraburi Specialties Sign</div>
				...
				<div class="more-all-01"><a href="benefits-good-product.php">View All</a></div>
		...
		<div class="left-03">
			<div class="box-main">
				<div class="title-all">Member</div>
				...
				<div class="more-all-01"><a href="benefits-member.php">View All</a></div>
