...
<?php
$form_registration = CheckHaveRowDB::slectFrom("form_registration", $_GET['id'])['data'];
foreach ($form_registration as $k => $v) {
?>
		...
		<div class="content">
			<div class="left-all">
				<div class="box-main">
					<div class="logo-member">
						<img src="../back-office/images/member/<?= $v['logo'] ?>" width="260" height="160" />
					</div>
					<div class="title-member-top"><?= $v['name_establishment'] ?></div>
				</div>
			</div>
			...
			<div class="left-member">
				<div class="box-main">
					<div class="banner">
						<section id="slippry-slider" class="full-width">
							<article class="demo_block">
								...
								<ul id="demo1">
									<?php
									$slide = explode(",", $v['slide_banner']);
									foreach ($slide as $k_sl => $v_sl) {
									?>
										<li><img src="../back-office/images/member/<?= $v_sl ?>"></li>
					...
					<div class="picture-member"><img src="../back-office/images/member/<?= $v["main_img"] ?>" width="620" height="415" /></div>
					...
					<div class="back-all-01"><a href="benefits-member.php">
							< Back</a>
					</div>
				</div>
