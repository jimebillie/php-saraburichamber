            ...
            <div class="box-main">
                ...
                <div class="box-text-aboutus">
                    ...
                    <div class="box-select-type">
                        ...
                        <div class="select-type-02"><a href="register-ordinary.php">Ordinary person</a></div>
                        <div class="select-type"><a href="register-juristic.php">Juristic person</a></div>
                    </div>
                    <form id="form_send" onsubmit="sendData(event)" enctype="multipart/form-data">
                        <div class="box-form">
                            ...
                            <div class="form-list">
                                <div class="form-left">Legal entity number</div>
                                <div class="form-right"><input name="number_legal_entity" required type="text" class="input-01" /></div>
                            </div>
                            <div class="form-list">
                                <div class="form-left">Registration date</div>
                                <div class="form-right"><input name="establishment_date" required type="date" class="input-01"></div>
                            </div>
                            <div class="form-list">
                                <div class="form-left">Attach commercial registration file</div>
                                <div class="form-right"><input type="file" name="commercial_registration_file" required class="input-01" /></div>
                            </div>
