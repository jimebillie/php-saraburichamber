...
if ($type_file[0] !== "image" || $type_file2[0] !== "image") {
     ...
     */
    try {
        move_uploaded_file($file["tmp_name"], "../images/home/banner/en/" . $newName);
        move_uploaded_file($file2["tmp_name"], "../images/home/banner/en/" . $newName2);
    } catch (Exception $e) {
        echo $e;
    }
    /**
     ...
     */
    try {
        $stmt = $db->conn->prepare("INSERT INTO `home_banner_en`(`pc`, `mobile`) VALUES (:pc, :mobile)");
