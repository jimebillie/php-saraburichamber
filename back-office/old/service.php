...
<body>
    ...
    <div id="wrap-content" class="content_show">
        <div class="area-content">
            ...
            <div class="mb-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="sys_service/add_service.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <?php
                                $databack_name = '';
                                $databack_detail = '';
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="service_name" id="service_name" value="<?= $databack_name ?>" required>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea id="summernote1" class="form-control d-none" name="service_detail" rows="8" required><?= $databack_detail ?></textarea>
                                </div>
                                    ...
                                    <div class="col-6 col-md-2 my-3">
                                        <div class="card">
                                            <div class="card-header p-0 overflow-hidden h-[150px]">
                                                <img class="w-[100%] h-[150px] object-cover " src="images/service/<?= $row["service_image"] ?>" alt="">
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div>
                                                    <a class="text-yellow-500 underline cursor-pointer" href="service_edit.php?id=<?= $row["id"] ?>">แก้ไข</a>
                                                    <span class="text-red-500 underline cursor-pointer ml-2" onClick="del_service(<?= $row["id"] ?>)">ลบ</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function del_service(id) {
            if (confirm("Are you want to delete service ?")) {
                window.location.href = "sys_service/del_service.php?id=" + id
            }
        }
    </script>
