                        ...
                        <div class="card sticky top-[50px]">
                            ...
                            <div class="card-body">
                                <form action="./sys_news/add_news.php" method="post" enctype="multipart/form-data">
                                    <label for="">รูปภาพ <span class="text-xs"></span> :</label>
                                    <input class="form-control mb-3" type="file" name="_img" required>
                                    <label for="">หัวข้อข่าว แสดงหน้าภาษาไทย <span class="text-xs"></span> :</label>
                                    <input class="form-control mb-3" type="text" name="_nam_th" required>
                                    <label for="">หัวข้อข่าว แสดงหน้าภาษาอังกฤษ <span class="text-xs"></span> :</label>
                                    <input class="form-control mb-3" type="text" name="_nam_en" required>
                                    <label for="">รายละเอียดย่อ แสดงหน้าภาษาไทย<span class="text-xs"></span> :</label>
                                    <textarea class="form-control mb-3" rows="5" name="_desc_th" required></textarea>
                                    <label for="">รายละเอียดย่อ แสดงหน้าภาษาอังกฤษ<span class="text-xs"></span> :</label>
                                    <textarea class="form-control mb-3" rows="5" name="_desc_en" required></textarea>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body overflow-auto">
                                <table class="table table-striped table-bordered w-[100%]">
                                    ...
                                    <tbody>
                                        <?php
                                        $news =  CheckHaveRowDB::slectFrom("news");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-danger" onclick="confirm('ต้องการลบหรือไม่') ? window.location.href='sys_news/del_news.php?id=<?= $v[0] ?>' : false">ลบ</button>
                                                    
                                                    <button class="btn btn-info" onclick="window.location.href='news_manage.php?id=<?= $v[0] ?>'">
                                                        จัดการข้อมูล
                                                    </button>
