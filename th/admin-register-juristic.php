            ...
            <div class="box-main">
                ...
                <div class="box-text-aboutus">
                    ...
                    <div class="box-select-type">
                        ...
                        <div class="select-type-02"><a href="admin-register-ordinary.php">บุคคลธรรมดา</a></div>
                        <div class="select-type"><a href="admin-register-juristic.php">นิติบุคล</a></div>
                    </div>
                    ...
                    <form id="form_send" onsubmit="sendData(event)" enctype="multipart/form-data">
                        <div class="box-form">
                            ...
                            <div class="form-list">
                                ...
                                <div class="form-right"><input name="number_legal_entity"  type="text" class="input-01" /></div>
                            </div>
                            <div class="form-list">
                                <div class="form-left">วันที่จดทะเบียนจัดตั้ง</div>
                                <div class="form-right"><input name="establishment_date"  type="date" class="input-01"></div>
                            </div>
                            <div class="form-list">
                                <div class="form-left">แนบไฟล์ ทะเบียนพาณิชย์</div>
                                <div class="form-right"><input type="file" name="commercial_registration_file"  class="input-01" /></div>
                            </div>
