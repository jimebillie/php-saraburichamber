...
<body>
    ...
    <div class="content">
        <div class="left-all">
            <div class="box-main">
                <div class="title-top">ติดต่อเรา</div>
                <div class="box-form-contact">
                    <form id="form_mail" method="post" onsubmit="sendMail(event)">
                        ...
                        <div class="form-list">
                            <div class="form-left">เบอร์โทรศัพท์</div>
                        ...
                        <div class="form-list">
                            <div class="form-left">ข้อความ</div>
                            <div class="form-right"><textarea name="_msg" cols="" rows="" class="input-03" required></textarea></div>
                        </div>

                        <div class="form-list">
                            <div class="form-right"><input type="submit" value="ส่งข้อมูล" class="btn-send-02"></input></div>
                        </div>
                    </form>
