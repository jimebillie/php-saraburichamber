    ...
    <div class="left-all">
      <div class="box-main">
        ...
        <div class="box-text-aboutus">
          <div class="title-aboutus">หน้าที่และภารกิจของหอการค้าจังหวัดสระบุรี</div>
          <div class="text-aboutus">
            <?php
            $aboutus_panel3 = CheckHaveRowDB::slectFrom("aboutus_panel3")['data'];
            foreach ($aboutus_panel3 as $k => $v) {
            ?>
              <?=
              nl2br($v['th']);
              ?>
