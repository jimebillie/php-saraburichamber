                ...
                <div class="box-text-aboutus">
                    <form id="form_send" onsubmit="sendData(event)" enctype="multipart/form-data">
                        ...
                        <div class="box-select-type">
                            ...
                            <div class="select-type-02"><a href="register-ordinary.php">บุคคลธรรมดา</a></div>
                            <div class="select-type"><a href="register-juristic.php">นิติบุคล</a></div>
